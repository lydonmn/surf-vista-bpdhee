...
const FEATURES = [
  ...
  {
    icon: "🌊",
    title: "Daily Surf Reports",
    description: "In-depth AI-powered surf condition reports every morning",
  },
  {
    icon: "📍",
    title: "All Locations",
    description: "Unlock surf data for all beaches and breaks",
  },
  {
    icon: "🔔",
    title: "Push Notifications",
    description: "Get alerts when conditions are firing at your spot",
  },
];
